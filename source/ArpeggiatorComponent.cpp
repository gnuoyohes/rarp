...
{
    createSliderAndAttachment (state, speedSlider, speedLabel, "Note Duration", speedSliderAttachment, "noteDur");
    createSliderAndAttachment (state, randomizeSlider, randomizeLabel, "Randomize", randomizeSliderAttachment, "randomize");
    createSliderAndAttachment (state, densitySlider, densityLabel, "Density", densitySliderAttachment, "density");
